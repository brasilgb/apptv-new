...
export const getDataFaturamento = async () => {
    ...
    const file:any = await fs.readFile(process.cwd() + '/mnt/apptv/faturamento-painel-tv.json');
...
export const getDataGrafico = async () => {
    ...
    const file = await fs.readFile(process.cwd() + '/mnt/apptv/grafico-painel-tv.json', 'utf8');
    const data = JSON.parse(file);
    return data;
}